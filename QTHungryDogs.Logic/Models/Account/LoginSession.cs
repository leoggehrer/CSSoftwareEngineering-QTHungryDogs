...
namespace QTHungryDogs.Logic.Models.Account
{
    public partial class LoginSession : VersionModel
    {
        ...
        static partial void BeforeCreate(QTHungryDogs.Logic.Entities.Account.LoginSession other);
        static partial void AfterCreate(QTHungryDogs.Logic.Models.Account.LoginSession instance, QTHungryDogs.Logic.Entities.Account.LoginSession other);
    }
}
#endif
//MdEnd
