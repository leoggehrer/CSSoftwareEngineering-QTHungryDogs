...
//MdStart
#if ACCOUNT_ON
namespace QTHungryDogs.Logic.Facades.Account
{
    ...
    public sealed partial class UsersFacade : FacadeObject, Contracts.Account.IUsersAccess<TModel>
    {
        ...
        public UsersFacade()
        : base(new QTHungryDogs.Logic.Controllers.Account.UsersController())
        {
            Constructing();
            Constructed();
        }
        public UsersFacade(FacadeObject facadeObject)
        : base(new QTHungryDogs.Logic.Controllers.Account.UsersController(facadeObject.ControllerObject))
        {
            Constructing();
            Constructed();
        }
