...
namespace QTHungryDogs.WebApi.Models.Base
{
    ...
    public partial class Restaurant
    {
        ...
        {
            return HashCode.Combine(DisplayName, OwnerName, UniqueName, Email, AddressStreet, AddressHousenumber, HashCode.Combine(AddressZipcode, AddressCity, State, OpeningHours, SpecialOpeningHours, RowVersion, HashCode.Combine(Id)));
        }
    }
}
