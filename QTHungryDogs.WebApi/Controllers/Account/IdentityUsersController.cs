...
{
    using TAccessModel = QTHungryDogs.Logic.Models.Account.User;
    using TEditModel = QTHungryDogs.WebApi.Models.Account.IdentityUserEdit;
    using TOutModel = QTHungryDogs.WebApi.Models.Account.IdentityUser;
    ///
    ...
    public sealed partial class IdentityUsersController : Controllers.GenericController<TAccessModel, TEditModel, TOutModel>
    {
        ...
        /// Generated by the generator
        ///
        public IdentityUsersController(QTHungryDogs.Logic.Contracts.Account.IUsersAccess<TAccessModel> other)
        : base(other)
        {
            Constructing();
            Constructed();
