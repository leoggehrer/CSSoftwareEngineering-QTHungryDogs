...
namespace QTHungryDogs.AspMvc.Controllers.Base
{
    ...
    using AccessType = QTHungryDogs.Logic.Entities.Base.Restaurant;
    using ModelType = QTHungryDogs.AspMvc.Models.Base.Restaurant;
    using FilterType = QTHungryDogs.AspMvc.Models.Base.RestaurantFilter;
    ///
    ...
    public sealed partial class RestaurantsController : Controllers.GenericController<AccessType, ModelType>
    {
        ...
        /// Generated by the generator
        ///
        public RestaurantsController(QTHungryDogs.Logic.Contracts.Base.IRestaurantsAccess<AccessType> other)
        : base(other)
        {
            Constructing();
            Constructed();
